...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDERPHCPZQJL3VFU6PSLEGJD67RJNOLWADIBVET62A2GHLHZDZPSAWSS";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        reset: (json: string) => AssembledTransaction<null>;
        decrement: (json: string) => AssembledTransaction<null>;
